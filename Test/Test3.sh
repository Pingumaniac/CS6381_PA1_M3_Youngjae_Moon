...
h3 python3 PublisherAppln.py -T 4 -n pub1 -d "localhost:5012" -p 5016 > test3_pub1.out 2>&1 &
h4 python3 PublisherAppln.py -T 4 -n pub2 -d "localhost:5012" -p 5017 > test3_pub2.out 2>&1 &
h5 python3 PublisherAppln.py -T 4 -n pub3 -d "localhost:5012" -p 5018 > test3_pub3.out 2>&1 &
h6 python3 PublisherAppln.py -T 4 -n pub4 -d "localhost:5012" -p 5019 > test3_pub4.out 2>&1 &
h7 python3 PublisherAppln.py -T 4 -n pub5 -d "localhost:5012" -p 5020 > test3_pub5.out 2>&1 &
h8 python3 PublisherAppln.py -T 4 -n pub6 -d "localhost:5012" -p 5021 > test3_pub6.out 2>&1 &
h9 python3 PublisherAppln.py -T 4 -n pub7 -d "localhost:5012" -p 5022 > test3_pub7.out 2>&1 &
h10 python3 PublisherAppln.py -T 4 -n pub8 -d "localhost:5012" -p 5023 > test3_pub8.out 2>&1 &
