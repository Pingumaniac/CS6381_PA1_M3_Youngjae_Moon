...
h2 python3 BrokerAppln.py -n broker1 -p 5578 &
h3 python3 PublisherAppln.py -T 5 -n pub1 -p 5570 &
h4 python3 PublisherAppln.py -T 5 -n pub2 -p 5571 &
h5 python3 PublisherAppln.py -T 5 -n pub3 -p 5572 &
h6 python3 PublisherAppln.py -T 5 -n pub4 -p 5573 &
