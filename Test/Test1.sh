...
h2 python3 BrokerAppln.py -n broker1 -p 5578 > test1_broker.out 2>&1 &
h3 python3 PublisherAppln.py -T 5 -n pub1 -p 5570 > test1_pub1.out 2>&1 &
h4 python3 PublisherAppln.py -T 5 -n pub2 -p 5571 > test1_pub2.out 2>&1 &
h5 python3 PublisherAppln.py -T 5 -n pub3 -p 5572 > test1_pub3.out 2>&1 &
h6 python3 PublisherAppln.py -T 5 -n pub4 -p 5573 > test1_pub4.out 2>&1 &
