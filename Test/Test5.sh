...
h2 python3 BrokerAppln.py -d "10.0.0.1:5000" -a "10.0.0.2" -n broker -p 5001 > test5_broker.out 2>&1 &
h3 python3 PublisherAppln.py -d "10.0.0.1:5000" -a "10.0.0.3" -T 4 -n pub1 > pub1.out 2>&1 &
h4 python3 PublisherAppln.py -d "10.0.0.1:5000" -a "10.0.0.4" -T 4 -n pub2 > pub2.out 2>&1 &
h5 python3 PublisherAppln.py -d "10.0.0.1:5000" -a "10.0.0.5" -T 4 -n pub3 > pub3.out 2>&1 &
h6 python3 PublisherAppln.py -d "10.0.0.1:5000" -a "10.0.0.6" -T 4 -n pub4 > pub4.out 2>&1 &
h7 python3 PublisherAppln.py -d "10.0.0.1:5000" -a "10.0.0.3" -T 4 -n pub5 > pub5.out 2>&1 &
h8 python3 PublisherAppln.py -d "10.0.0.1:5000" -a "10.0.0.4" -T 4 -n pub6 > pub6.out 2>&1 &
h9 python3 PublisherAppln.py -d "10.0.0.1:5000" -a "10.0.0.5" -T 4 -n pub7 > pub7.out 2>&1 &
h10 python3 PublisherAppln.py -d "10.0.0.1:5000" -a "10.0.0.6" -T 4 -n pub8 > pub8.out 2>&1 &
