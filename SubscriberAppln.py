...
class SubscriberAppln():
  ...
  # by the middleware's event loop after it sees a timeout has occurred.
  ########################################
  def invoke_operation (self):
    ...
    try:
      ...
      if (self.state == self.State.REGISTER):
        ...
        self.logger.info ("SubscriberAppln::invoke_operation - RECEIVING Messages as shown below:")
        ...
        self.saveJSON(msg, current_time)
